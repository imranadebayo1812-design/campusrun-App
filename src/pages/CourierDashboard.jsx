...
function FraudWarningModal({ itemName, onAccept, onClose }) {
  return (
    <div className="fixed inset-0 z-[200] flex items-end justify-center kb-backdrop" style={{ backgroundColor: 'rgba(0,0,0,0.8)' }}>
...
function ItemPriceEditModal({ target, onSubmit, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end justify-center kb-backdrop" style={{ backgroundColor: 'rgba(0,0,0,0.75)' }}>
      <div className="w-full max-w-md bg-surface-900 border border-white/[0.08] rounded-t-3xl p-5 space-y-4"
        style={{ paddingBottom: 'calc(1.25rem + env(safe-area-inset-bottom))' }}>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">

...
function WithdrawToBankModal({ maxAmount, onSuccess, onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-end justify-center p-0 overflow-hidden" style={{ backgroundColor: 'rgba(0,0,0,0.7)' }}>
      <div data-scroll className="w-full max-w-md bg-surface-900 border border-white/[0.08] rounded-t-3xl p-5 space-y-4 max-h-[90vh] overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
